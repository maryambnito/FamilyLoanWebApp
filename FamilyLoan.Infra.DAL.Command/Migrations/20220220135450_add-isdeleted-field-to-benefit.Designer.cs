...
namespace FamilyLoan.Infra.DAL.Command.Migrations
{
    ...
    [Migration("20220220135450_add-isdeleted-field-to-benefit")]
    partial class addisdeletedfieldtobenefit
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FamilyLoan.Core.Domains.Moeins.Moein", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FamilyLoan.Core.Domains.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("FamilyLoan.Core.Domains.Roles.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("FamilyLoan.Core.Domain.Customers.Customer", null)
                        .WithMany()
